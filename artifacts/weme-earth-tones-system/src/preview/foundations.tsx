...
const WEME_PALETTE = [
  { name: 'Sage green', hex: '#92946e' },
  { name: 'Burgundy', hex: '#9d202f' },
  { name: 'Warm orange', hex: '#f6c367' },
  { name: 'Dark purple / grey', hex: '#5c5154' },
  { name: 'Darker sage / olive', hex: '#767661' },
  { name: 'Light grey / purple', hex: '#b5b0b1' },
  { name: 'Mauve / rose', hex: '#af6e77' },
  { name: 'Dusty rose', hex: '#d799a1' },
  { name: 'Terracotta', hex: '#cb7a51' },
  { name: 'Muted gold', hex: '#c9ad6b' },
  { name: 'Very light sage', hex: '#cbcfbb' },
] as const;
  ...
  return (
    <div className="space-y-8 rounded-xl border bg-card p-6 text-card-foreground">
      <section className="space-y-4">
        <div>
          <h2 className="font-semibold">WeMe Earth Tones</h2>
          <p className="text-sm text-muted-foreground">
            The complete source palette. Semantic roles and chart colors are
            derived from these eleven tones.
          </p>
        </div>
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {WEME_PALETTE.map((swatch) => (
            <PaletteSwatch key={swatch.hex} {...swatch} />
          ))}
        </div>
      </section>
