# WeMe Earth Tones design system
...
workspace package (`@workspace/weme-earth-tones`): other artifacts depend
...
`@workspace/weme-earth-tones/components/...`. Never use a `@/` alias inside
...
for `@workspace/weme-earth-tones` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/weme-earth-tones` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/weme-earth-tones/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/weme-earth-tones/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/weme-earth-tones/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/weme-earth-tones/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/weme-earth-tones/docs/migrating-expo.md`
