export default function Workflow() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text">
      <div className="absolute right-[7vw] top-[6vh] font-body text-[1.25vw] font-bold uppercase tracking-[0.16em] text-accent">02 / Arbeidsflyt</div>
      <div className="flex h-full flex-col px-[8vw] py-[8vh]">
        ...
        <p className="mt-[2vh] max-w-[50vw] font-body text-[1.55vw] leading-[1.3] text-muted">
        ...
        <div className="mt-[8vh] flex items-stretch gap-[1vw]">
          <div className="flex h-[28vh] flex-1 flex-col justify-between bg-primary p-[2vw] text-[#f4f0e8]">
            <span className="font-body text-[1.15vw] font-bold text-accent">01</span>
            <p className="font-display text-[2.15vw] font-semibold leading-[1.02]">Konto-<br />univers</p>
            <p className="font-body text-[1.25vw] text-[#f4f0e8]/65">ICP og historikk</p>
          </div>
          <div className="flex h-[28vh] flex-1 flex-col justify-between border-[0.12vw] border-primary/25 bg-[#ebe6dc] p-[2vw]">
            <span className="font-body text-[1.15vw] font-bold text-accent">02</span>
            <p className="font-display text-[2.15vw] font-semibold leading-[1.02]">Signal-<br />søk</p>
            <p className="font-body text-[1.25vw] text-muted">Offentlige endringer</p>
          </div>
          <div className="flex h-[28vh] flex-1 flex-col justify-between border-[0.12vw] border-primary/25 bg-[#ebe6dc] p-[2vw]">
            <span className="font-body text-[1.15vw] font-bold text-accent">03</span>
            <p className="font-display text-[2.15vw] font-semibold leading-[1.02]">Kilde-<br />verifisering</p>
            <p className="font-body text-[1.25vw] text-muted">Dato, sitat, ferskhet</p>
          </div>
          <div className="flex h-[28vh] flex-1 flex-col justify-between border-[0.12vw] border-primary/25 bg-[#ebe6dc] p-[2vw]">
            <span className="font-body text-[1.15vw] font-bold text-accent">04</span>
            <p className="font-display text-[2.15vw] font-semibold leading-[1.02]">CRM-<br />sjekk</p>
            <p className="font-body text-[1.25vw] text-muted">Unngå konflikt</p>
          </div>
        </div>
        ...
        <div className="mt-[4vh] flex items-center justify-between">
          <p className="max-w-[38vw] font-body text-[1.55vw] leading-[1.25] text-muted">Menneskelig vurdering: godkjenn, avvis eller følg videre</p>
        ...
        <div className="mt-auto font-body text-[1.35vw] text-muted">Feedback gjør neste vurdering bedre</div>
      </div>
    </div>
  );
}