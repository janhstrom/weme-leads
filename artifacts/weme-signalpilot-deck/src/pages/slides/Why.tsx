  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text">
      ...
      <div className="relative flex h-full flex-col px-[8vw] py-[8vh]">
        <p className="font-body text-[1.25vw] font-bold uppercase tracking-[0.16em] text-accent">01 / Utgangspunkt</p>
        ...
        <div className="mt-[8vh] grid max-w-[78vw] grid-cols-2 gap-x-[6vw] gap-y-[5vh]">
          <div className="border-t-[0.16vw] border-primary/25 pt-[2vh]">
            ...
            <p className="mt-[1.5vh] font-body text-[1.7vw] leading-[1.25] text-muted">D&amp;B- og Sales Navigator-lister viser hvem som passer ICP — ikke hvorfor nå</p>
          </div>
          <div className="border-t-[0.16vw] border-primary/25 pt-[2vh]">
            <p className="font-display text-[2.15vw] font-semibold leading-[1.05]">Hva skjer nå?</p>
            <p className="mt-[1.5vh] font-body text-[1.7vw] leading-[1.25] text-muted">CRM viser relasjon og eksklusjon — ikke fersk endring</p>
          </div>
          <div className="border-t-[0.16vw] border-primary/25 pt-[2vh]">
            <p className="font-display text-[2.15vw] font-semibold leading-[1.05]">Hvorfor tror vi det?</p>
            <p className="mt-[1.5vh] font-body text-[1.7vw] leading-[1.25] text-muted">Offentlige signaler må kobles til kilde, dato, sitat og kontaktvinkel</p>
          </div>
          <div className="border-t-[0.16vw] border-accent pt-[2vh]">
            ...
            <p className="mt-[1.5vh] font-body text-[1.7vw] leading-[1.25] text-muted">Et lite team trenger en arbeidsflyt, ikke en ny salgsplattform</p>
          </div>
        </div>
        <div className="mt-auto flex items-center gap-[1.5vw] font-body text-[1.35vw] text-muted">
