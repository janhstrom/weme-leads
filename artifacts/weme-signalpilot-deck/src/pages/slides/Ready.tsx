export default function Ready() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-bg text-text">
      <div className="absolute left-[8vw] top-[7vh] font-body text-[1.5vw] font-bold uppercase tracking-[0.16em] text-accent">03 / Status</div>
        ...
        <div className="mt-[7vh] grid max-w-[78vw] grid-cols-3 gap-[1.2vw]">
          <div className="col-span-2 bg-primary p-[2vw] text-[#f4f0e8]">
            <div className="flex items-end justify-between">
              ...
              <p className="font-body text-[1.5vw] uppercase tracking-[0.12em] text-[#f4f0e8]/60">Signalinnboks</p>
            </div>
            <p className="mt-[3vh] max-w-[42vw] font-body text-[2vw] leading-[1.15]">Signalinnboks med søk, status og A/B/C-prioritet</p>
          </div>
          <div className="bg-[#ebe6dc] p-[2vw]">
            ...
            <p className="mt-[3vh] font-body text-[2vw] leading-[1.15]">Detaljvisning med kilde, ferskhet, sitat og endringsrelevans</p>
          </div>
          <div className="border-[0.12vw] border-primary/25 bg-[#ebe6dc] p-[2vw]">
            ...
            <p className="mt-[3vh] font-body text-[2vw] leading-[1.15]">Anbefalt kontakt, åpningsspørsmål og dialogutkast</p>
          </div>
          <div className="border-[0.12vw] border-primary/25 bg-[#ebe6dc] p-[2vw]">
            <p className="font-display text-[4.7vw] font-semibold leading-none tracking-[-0.08em]">04</p>
            <p className="mt-[3vh] font-body text-[2vw] leading-[1.15]">Persistente signaler og review-feedback i databasen</p>
          </div>
          <div className="border-[0.12vw] border-accent bg-[#ebe6dc] p-[2vw]">
            ...
            <p className="mt-[3vh] font-body text-[2vw] leading-[1.15]">CRM-skriving er sperret til signal og kontakt er godkjent og verifisert</p>
          </div>
        </div>
