...
export function SdmInteractionLayer({
  ...
  const handleSize = 8 / visualScale;
  const rotationHandleSize = 12 / visualScale;
  const rotationHandleOffset = 16 / visualScale;
  const rotationIconSize = 7 / visualScale;
